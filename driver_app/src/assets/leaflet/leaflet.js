    ...
    _containsPoint: function (t, e) {
      ...
      if (this._pxBounds && this._pxBounds.contains(t))
        for (i = 0, s = this._parts.length; i < s; i++)
          for (n = 0, o = (r = (a = this._parts[i]).length) - 1; n < r; o = n++) if ((e || 0 !== n) && Qe(t, a[o], a[n]) <= h) return !0;
      return !1;
    },
  });
  vi._flat = oi;
      ...
      Oi.extend({
        ...
        onAdd: function (t) {
          Oi.prototype.onAdd.call(this, t),
            ...
            this._source &&
              (this._source.fire('popupopen', { popup: this }, !0), this._source instanceof mi || this._source.on('preclick', Ae));
        },
        onRemove: function (t) {
          Oi.prototype.onRemove.call(this, t),
            t.fire('popupclose', { popup: this }),
            this._source &&
              (this._source.fire('popupclose', { popup: this }, !0), this._source instanceof mi || this._source.off('preclick', Ae));
        },
        getEvents: function () {
    ...
    zt = {
      ...
      _updateStyle: function (t) {
        ...
        (o.stroked = !!n.stroke),
          ...
          n.fill
            ? ((i = i || (t._fill = Ui('fill'))), o.appendChild(i), (i.color = n.fillColor || n.color), (i.opacity = n.fillOpacity))
