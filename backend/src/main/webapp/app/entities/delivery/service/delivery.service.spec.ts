...
const requireRestSample: RestDelivery = {
  ...
  request_time: sampleWithRequiredData.request_time?.toJSON(),
  assigned_time: sampleWithRequiredData.assigned_time?.toJSON(),
  estimated_time: sampleWithRequiredData.estimated_time?.toJSON(),
  ended_time: sampleWithRequiredData.ended_time?.toJSON(),
};
